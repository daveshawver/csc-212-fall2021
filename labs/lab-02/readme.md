 ...
 * At the beginning of each Lab session, we will give a brief rundown of the day's exercises & answer any immediate questions students may have.
 * Once the lab has been introduced, you are to work on the Lab assignment **individually**. You are of course encouraged to discuss the problem amongst yourselves and ask your assigned TA for help, but there will be **no** pair-programming/sharing of solutions.
